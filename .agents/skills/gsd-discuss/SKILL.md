...
description: >-
  ...
  user intent, architectural choices, and boundaries into .planning/phases/XX/CONTEXT.md before code is planned or written.
---
...
1. **Identify the Active Phase**:
   Read `.planning/STATE.md` to identify the current milestone and phase directory (e.g. `.planning/phases/01-foundation/`).
...
3. **Write `CONTEXT.md`**:
   Persist all decisions in `.planning/phases/XX/CONTEXT.md` with:
   - Objective & Scope
...
4. **Update `STATE.md`**:
   Record the completion of the discussion phase in `.planning/STATE.md`.
