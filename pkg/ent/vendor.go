...
func (e VendorEdges) PackagesOrErr() ([]*MediaPackage, error) {
	if e.loadedTypes[0] {
...
// QueryPackages queries the "packages" edge of the Vendor entity.
func (_m *Vendor) QueryPackages() *MediaPackageQuery {
	return NewVendorClient(_m.config).QueryPackages(_m)
}
