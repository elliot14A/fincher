...
func (_u *TitleUpdate) AddDeliveryIDs(ids ...string) *TitleUpdate {
	_u.mutation.AddDeliveryIDs(ids...)
	return _u
}

// AddDeliveries adds the "deliveries" edges to the Delivery entity.
func (_u *TitleUpdate) AddDeliveries(v ...*Delivery) *TitleUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *TitleUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.DeliveriesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   title.DeliveriesTable,
			Columns: []string{title.DeliveriesColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddDeliveryIDs adds the "deliveries" edge to the Delivery entity by IDs.
func (_u *TitleUpdateOne) AddDeliveryIDs(ids ...string) *TitleUpdateOne {
	_u.mutation.AddDeliveryIDs(ids...)
	return _u
}

// AddDeliveries adds the "deliveries" edges to the Delivery entity.
func (_u *TitleUpdateOne) AddDeliveries(v ...*Delivery) *TitleUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearDeliveries clears all "deliveries" edges to the Delivery entity.
func (_u *TitleUpdateOne) ClearDeliveries() *TitleUpdateOne {
	_u.mutation.ClearDeliveries()
	return _u
}

// RemoveDeliveryIDs removes the "deliveries" edge to Delivery entities by IDs.
func (_u *TitleUpdateOne) RemoveDeliveryIDs(ids ...string) *TitleUpdateOne {
	_u.mutation.RemoveDeliveryIDs(ids...)
	return _u
}

// RemoveDeliveries removes "deliveries" edges to Delivery entities.
func (_u *TitleUpdateOne) RemoveDeliveries(v ...*Delivery) *TitleUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
