...
func (_q *DeliveryQuery) QueryTitle() *TitleQuery {
...
func (_q *DeliveryQuery) WithTitle(opts ...func(*TitleQuery)) *DeliveryQuery {
	query := (&TitleClient{config: _q.config}).Query()
...
func (_q *DeliveryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Delivery, error) {
	...
	if query := _q.withTitle; query != nil {
		if err := _q.loadTitle(ctx, query, nodes, nil,
			func(n *Delivery, e *Title) { n.Edges.Title = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DeliveryQuery) loadTitle(ctx context.Context, query *TitleQuery, nodes []*Delivery, init func(*Delivery), assign func(*Delivery, *Title)) error {
...
func (_q *DeliveryQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTitle != nil {
			_spec.Node.AddColumnOnce(delivery.FieldTitleID)
		}
	}
